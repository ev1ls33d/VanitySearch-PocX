...
- **macOS** CPU-only (CUDA not available on macOS)
...
**Note**: The workflow patches the Visual Studio project to use CUDA 12.6 instead of CUDA 13.1.
...
**Note**: macOS does not support NVIDIA CUDA. This is a CPU-only build without GPU acceleration.
